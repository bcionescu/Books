...
As the AI hype continues to swell, I’ve chosen to mostly ignore it, and instead read some programming books, like the legendary boomer programmers did. What better way to learn, and to train your attention span, than reading a 1,500 page book on Linux system calls?
...
- [C Programming Language](https://geni.us/c-kernighan-ritchie)

Probably the most well-known book on C, written by Brian Kernighan and Dennis Ritchie. It covers many aspects of the C language.

- [C Programming: A Modern Approach](https://geni.us/c-programming)

Covers both C89 and C99, and I found it easier to follow than the 

- [But How Do It Know?](https://geni.us/but-how-do-it-know)
